...
export function ChartRabbitLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <polygon points="26,18 46,32 36,44 16,30" fill="#ffffff" />

      {/* Right Ear (standing straight up) */}
      <polygon points="60,20 74,24 74,52 60,48" fill="#ffffff" />

      {/* Isometric Box Top Face */}
      <polygon points="50,42 78,54 50,66 22,54" fill="#ffffff" />

      {/* Isometric Box Left Face */}
      <polygon points="22,54 50,66 50,88 22,76" fill="#ffffff" />

      {/* Isometric Box Right Face */}
      <polygon points="50,66 78,54 78,76 50,88" fill="#ffffff" />

      {/* Face Expression: ^ + ^ on Left Face */}
      <path d="M 29 63 Q 32 60 35 63" fill="none" strokeWidth="4" />
      <path d="M 35 71 L 41 67 M 38 66 L 38 72" strokeWidth="4" />
      <path d="M 42 68 Q 45 65 48 68" fill="none" strokeWidth="4" />
    </svg>
  )
}
...
export function CandlestickChartIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="18"
...
export function ChartLineUpIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="18"
...
export function BarChart3Icon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path d="M3 3v18" />
      <rect width="4" height="6" x="7" y="12" rx="1" />
      <rect width="4" height="10" x="11" y="8" rx="1" />
      <rect width="4" height="4" x="15" y="14" rx="1" />
    </svg>
  )
}
...
export function WalletIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      <path d="M21 12h-6a2 2 0 0 1-2-2V7" />
      <path d="M16 12h6" />
      <path d="M19 15v6" />
    </svg>
  )
...
export function ScrollTextIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M8 21h12a2 2 0 0 0 2-2v-2H8a2 2 0 0 1-2-2V3H4v14a2 2 0 0 0 2 2z" />
      <path d="M19 17V7" />
      <path d="M4 7V3" />
      <path d="M8 7v4" />
      <path d="M12 7v4" />
...
export function PaperclipIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="m21.44 11.05-9.19 9.19a6 6 0 0 1-8.49-8.49l8.57-8.57a4 4 0 1 1 5.66 5.66l-8.58 8.57a2 2 0 0 1-2.83-2.83l8.49-8.48" />
    </svg>
  )
}
